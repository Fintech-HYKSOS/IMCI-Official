    ...
    return (
        <div className='bg-white shadow-1 p-5 rounded-lg rounded-tl-[] w-full max-w-[320px] mx-auto hover:shadow-2xl transition'>
            ...
            <div className='mb-5 flex flex-wrap justify-center gap-2 text-sm'>
                <div className='bg-[#05182a] rounded-full text-white px-3'>{type}</div>
            </div>

            <div className='mb-5 flex justify-center gap-x-2 text-sm'>
                <div className={`bg-[#134d13] rounded-full text-xl text-center text-white w-full p-1`}>{price} FCFA</div>
            </div>
            
            <div className='text-md font-semibold w-full'>{address}</div>

            <div className='flex gap-x-4 my-4'>
                <button onClick={() => navigate(`/PropertyDetail/${id}`)} type="button" to={href} className="focus:outline-none text-white 
                ...
                <button onClick={() => navigate(`/Souscription`)} type="button" to={href} className="focus:outline-none text-white 
