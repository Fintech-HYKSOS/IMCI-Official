...
export default function Footer() {
    ...
    return (
        <footer
            className="bg-[#001C54] text-center text-neutral-600 text-neutral-200 lg:text-left">
            {/* <div
        className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
        <div className="mr-12 hidden lg:block">
          <span>Restez connecté avec nous sur les reseaux sociaux:</span>
        </div> */}
          ...
          <a className="text-neutral-200">
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="">
                        <h6
                            className="mb-4 text-[#00aa9b] flex justify-center font-semibold uppercase md:justify-start">
                            Abonnements
                        </h6>
                        <p className="mb-4">
                    ...
                    <div>
                        ...
                        <p className="mb-4 text-neutral-200 flex items-center justify-center md:justify-start">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                className="mr-3 h-5 w-5 text-[#00aa9b]">
                                <path
                                    d="M11.47 3.84a.75.75 0 011.06 0l8.69 8.69a.75.75 0 101.06-1.06l-8.689-8.69a2.25 2.25 0 00-3.182 0l-8.69 8.69a.75.75 0 001.061 1.06l8.69-8.69z" />
                                <path
                                    d="M12 5.432l8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 01-.75-.75v-4.5a.75.75 0 00-.75-.75h-3a.75.75 0 00-.75.75V21a.75.75 0 01-.75.75H5.625a1.875 1.875 0 01-1.875-1.875v-6.198a2.29 2.29 0 00.091-.086L12 5.43z" />
                            </svg>
                            Côte d'Ivoire, Abidjan, Angré Chateau
                        </p>
                        <p className="mb-4 text-neutral-200 flex items-center justify-center md:justify-start">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
            ...
            {/* <!--Copyright section--> */}
            <div className="bg-[#001032] p-6 text-center">
                <span className='text-neutral-200'>© 2024 Copyright : </span>
                <a
