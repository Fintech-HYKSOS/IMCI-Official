...
export const LowPricing = () => {
    ...
    return (
        <Link to={`/PaymentFormulas/Basic_Souscription`} className="py-12 px-4 flex flex-col rounded-xl border-2 border-dashed border-gray-400 text-center transition duration-75 hover:rotate-1 hover:scale-105 focus:rotate-1 focus:scale-105">
            <div>
            ...
            <div className="mt-16">
                <div onClick={() => navigate(`/PaymentFormulas/Basic_Souscription`)} className="group cursor-pointer inline-flex items-center justify-center text-md md:text-xl font-bold text-white px-6 py-3 rounded bg-teal-500 hover:bg-sky-600 focus:bg-blue-600">
...
export const HighPricing = () => {
    const navigate = useNavigate(); 
    return (
        <Link to={`/PaymentFormulas/VIP_Souscription`} className="pricing-custom py-12 px-4 flex flex-col rounded-xl bg-white text-gray-900 text-center transition duration-75 hover:-rotate-1 hover:scale-105 focus:-rotate-1 focus:scale-105">
            <div>
            ...
            <div className="mt-16">
                <div onClick={() => navigate(`/PaymentFormulas/VIP_Souscription`)} className="group cursor-pointer inline-flex items-center justify-center text-md md:text-xl font-bold text-white px-6 py-3 rounded bg-teal-500 hover:bg-sky-600 focus:bg-blue-600">
                    Cliquer pour choisir ce forfait
                    <SvgIconTransfer />
                </div>
            </div>
